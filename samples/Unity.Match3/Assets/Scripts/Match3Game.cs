...
public abstract class Match3Game : BaseGame
{
    ...
    /// 棋盘填充
    private async UniTask FillAsync(RiseFillStrategy fillStrategy, CancellationToken cancellationToken = default)
    {
        await ExecuteJobsAsync(fillStrategy.GetBoardFillJobs(GameBoard), cancellationToken);
    }
