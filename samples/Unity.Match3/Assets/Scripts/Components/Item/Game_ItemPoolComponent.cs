...
namespace Match3
{
    public class Game_ItemPoolComponent : Component
    {
        ...
        {
            var rowCount = World.Instance.rowCount;
            var columnCount = World.Instance.columnCount;
        ...
        public Game_ItemComponent Fetch()
        {
        ...
        // 回收一个 tile 回池中
        public void Recycle(Game_ItemComponent itemComponent)
        {
            itemComponent.Hide();
