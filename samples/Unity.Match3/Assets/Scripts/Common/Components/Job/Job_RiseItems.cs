...
namespace Match3
{
    public class Job_RiseItems : Job_BaseMove
    {
        ...
        public Job_RiseItems(IEnumerable<ItemMoveData> items, int delayMultiplier = 0, int executionOrder = 0) : base(executionOrder)
        {
            _itemsData = items;
        ...
        private static Tween CreateItemFadeInTween(Game_ItemComponent itemComponent)
        {
