...
namespace Match3
{
    public class Game_BoardRenderComponent : Component
    {
        ...
        private Game_ItemPoolComponent _itemPoolComponent;

        public void Init(int rowCount, int columnCount, float tileSize)
        {
